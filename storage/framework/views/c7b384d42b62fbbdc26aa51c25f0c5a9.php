    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            <div class="lg:col-span-2">
                <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold tracking-tight text-gray-900">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="<?php echo e(route('products.index')); ?>" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">All Products</a></li>
                    <li><a href="<?php echo e(route('products.index', ['sort' => 'newest'])); ?>" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">New Arrivals</a></li>
                    <li><a href="<?php echo e(route('products.index')); ?>" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">Featured</a></li>
                </ul>
            </div>
        ...
        <div class="py-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-sm text-gray-500">© <?php echo e(date('Y')); ?> ShoeStore™. All Rights Reserved.</p>
...
<?php /**PATH D:\Laravel\shoe-store\resources\views/partials/footer.blade.php ENDPATH**/ ?>