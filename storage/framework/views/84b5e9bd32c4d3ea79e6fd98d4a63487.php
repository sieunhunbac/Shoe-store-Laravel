<?php $__env->startSection('title', 'Checkout - ShoeStore'); ?>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="customer_address" id="customer_address" rows="3" required
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-sm resize-none"><?php echo e(old('customer_address')); ?></textarea>
                        </div>

                        <div class="sm:col-span-2">
                            <label for="note" class="block text-sm font-medium text-gray-700 mb-1">Order Notes (optional)</label>
                            <textarea name="note" id="note" rows="2"
                                      class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent text-sm resize-none" placeholder="Any special requests..."><?php echo e(old('note')); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-24">
                        ...
                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500">Qty: <?php echo e($item->quantity); ?>
                    ...
                    <div class="space-y-2 mb-6">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-xl font-bold text-gray-900">$<?php echo e(number_format($total, 2)); ?></span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Laravel\shoe-store\resources\views/checkout/index.blade.php ENDPATH**/ ?>