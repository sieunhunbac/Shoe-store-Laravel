...
@section('title', 'ShoeStore - Step Into Style')
...
<section class="py-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-10">
            ...
            <a href="{{ route('products.index') }}" class="text-sm font-medium text-gray-900 hover:text-gray-600 transition-colors flex items-center gap-1">
                View All
